  ...
  void doReps(var inferenceResults) {
    if (isPostureCorrect()) {
      for (var target in targets) {
        ...
        var B = target[0][1];
        var C = target[0][2];
        print('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'+A);
        print('BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB'+B);
        print('CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC'+C);

        List<int> pointA = [inferenceResults[A][0], inferenceResults[A][1]];
        List<int> pointB = [inferenceResults[B][0], inferenceResults[B][1]];
        List<int> pointC = [inferenceResults[C][0], inferenceResults[C][1]];
        print('pointApointApointApointApointApointApointApointApointApoint');
        print(pointA);
        print('pointBpointBpointBpointBpointBpointBpointBpointBvpointBpoint');
        print(pointB);
        print("pointCpointCpointCpointCpointCpointCpointCpointCpointCpointC");
        print(pointC);
